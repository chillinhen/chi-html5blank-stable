<?php
// Add our Recommends Custom Post Type
...
add_action('init', 'create_post_type_recommends'); 

// Add our Benefits Custom Post Type
function create_post_type_benefits()
{
    register_taxonomy_for_object_type('category', 'benefits'); // Register Taxonomies for Category
    register_taxonomy_for_object_type('post_tag', 'benefits');
    register_post_type('benefits', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Benefits Custom Post', 'html5blank'), // Rename these to suit
        ...
        'supports' => array(
            ...
            'excerpt',
            'thumbnail'
        ), // Go to Dashboard Custom Benefits post for supports
        'can_export' => true, // Allows export in Tools > Export
        'taxonomies' => array(
            'post_tag',
            'category'
...
add_action('init', 'create_post_type_benefits'); 
?>